...
async function scanDefines(starter, baseUrl, includeAllResources=false, pathes) {
    ...
    unit.children.push(new ImportStmt('{Molecule, EventHandlerProvider}', locatePath(pathes, 'molecule/molecule-comp.js')));

    for(var template of Array.of(...starter.querySelectorAll('template'))){
        for(var el of Array.of(...template.content.querySelectorAll('import'))){
    ...
    for(var template of Array.of(...starter.querySelectorAll('template'))){
        for(var el of Array.of(...template.content.querySelectorAll('script'))){       // not class script of molecule, merge to unit
